...
def run_test_practice_problem2a():
    ...
    # Test 1
    print('Test 1:')
    print('Expected', [4, 5, 6, 7])
    print('actual', practice_problem2a([1, 2, 3, 4], 3))

    # Test 2
    print('Test 2:')
    print('Expected', [3, 4, 5, 6])
    print('actual', practice_problem2a([1, 2, 3, 4], 2))

    # Test 3
    print('Test 3:')
    print('Expected', [5, 6, 7, 8])
    print('actual', practice_problem2a([1, 2, 3, 4], 4))

    # Test 4
    print('Test 4:')
    print('Expected', [6, 7, 8, 9])
    print('actual', practice_problem2a([1, 2, 3, 4], 5))
